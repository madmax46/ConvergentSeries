...
namespace ConvergentSeries
{
    public class Parser
    {
        ...
        public static void InitializeParser()
        {
            ...
            ParserFunction.addFunction("tan", new TanFunction());
            ParserFunction.addFunction("ctg", new CtgFunction());
            ParserFunction.addFunction("asin", new AsinFunction());
            ParserFunction.addFunction("acos", new AcosFunction());
            ParserFunction.addFunction("atan", new AtanFunction());
            ParserFunction.addFunction("arctg", new ArctgFunction());
            ParserFunction.addFunction("log", new LogFunction());
            ParserFunction.addFunction("ln", new LnFunction());
    ...
    class TanFunction : ParserFunction
    {
        protected override double evaluate(string data, ref int from)
        {
            double arg = Parser.loadAndCalculate(data, ref from, Parser.END_ARG);
    ...
    class CtgFunction : ParserFunction
    {
        protected override double evaluate(string data, ref int from)
        {
            double arg = Parser.loadAndCalculate(data, ref from, Parser.END_ARG);
    ...
    class AtanFunction : ParserFunction
    {
        protected override double evaluate(string data, ref int from)
        {
            double arg = Parser.loadAndCalculate(data, ref from, Parser.END_ARG);
    ...
    class ArctgFunction : ParserFunction
    {
        protected override double evaluate(string data, ref int from)
        {
            double arg = Parser.loadAndCalculate(data, ref from, Parser.END_ARG);
            return Math.Asin(arg/Math.Sqrt(1+Math.Pow(arg,2)));
        }
    }
    ...
    class LnFunction : ParserFunction
    {
        protected override double evaluate(string data, ref int from)
        {
            double arg = Parser.loadAndCalculate(data, ref from, Parser.END_ARG);
            return Math.Log(arg,Math.E);
        }
    }
